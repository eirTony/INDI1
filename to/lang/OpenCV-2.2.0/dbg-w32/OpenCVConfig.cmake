...
SET(OpenCV_INCLUDE_DIRS "D:/lang/OpenCV-2.2.0/dbg-w32" "D:/lang/OpenCV-2.2.0/include" "D:/lang/OpenCV-2.2.0/include/opencv")
...
SET(OpenCV_LIB_DIR D:/lang/OpenCV-2.2.0/dbg-w32/lib)
...
IF (NOT 1)
    ...
    LINK_DIRECTORIES(D:/lang/OpenCV-2.2.0/dbg-w32/lib/../3rdparty/lib)
    if(WIN32)
        LINK_DIRECTORIES("D:/lang/OpenCV-2.2.0"/3rdparty/lib)
    else()
        LINK_DIRECTORIES(D:/lang/OpenCV-2.2.0/dbg-w32/lib/../share/opencv/3rdparty/lib)
    endif()    

	set(OpenCV_LIBS   comctl32;gdi32;ole32;vfw32;winmm ${OpenCV_LIBS})
